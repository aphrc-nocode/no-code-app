...
menu_translation = function(){
  output$dynamic_meinu_aphrc <- renderMenu({
    sidebarMenu(id = "tabs",
                ...
                ,
                menuItem(
                  HTML(paste0("<span class='menu-label'>", "Data Anonymization", "</span>")),
                  icon = icon("user-shield", lib = "font-awesome"),
                  menuSubItem("Quantitative Anonymization", tabName = "anonymization_quant", icon = icon("calculator")),
                  menuSubItem("Qualitative Anonymization",  tabName = "anonymization_qual",  icon = icon("align-left"))
                ),
