    ...
    conditionalPanel(
      ...
      tagList(
        ...
        tabsetPanel(
          ...
          tabPanel("ROC Curve",uiOutput(ns("roc_ui"))
                   #br(),
                   #shiny::downloadButton("roc_uidown", label = "donwload")
                   ),
          tabPanel("Confusion Matrix",   uiOutput(ns("cm_ui"))
                   #br(),
                   #shiny::downloadButton("cm_uidown", label = "donwload")
                   ),
          tabPanel("Feature Importance",
                  ...
                  uiOutput(ns("fi_ui"))
                   #br(),
                   #shiny::downloadButton("fi_uidown", label = "donwload")
                   ),
          tabPanel("SHAP Values", uiOutput(ns("shap_ui"))
                   #br(),
                   #shiny::downloadButton("shap_uidown", label = "donwload")
                   )
        )
      )
    ),
