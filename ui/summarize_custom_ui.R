  ...
  tabItem(
    ...
    fluidRow(
      ...
      column(
        ...
        div(
          id = "customOutputTypePanel",
          style = "margin-bottom:14px; padding-bottom:10px; border-bottom:1px solid #e5e7eb;",
      ...
      column(
        ...
        conditionalPanel(
          ...
          div(
            ...
            uiOutput("user_select_facet_variable"),
